...
const NAV_LINKS = [
  ...
  { key: 'news' as const, href: '/blog?category=news' },
  { key: 'destinations' as const, href: '/blog?category=destinations' },
  { key: 'lifestyle' as const, href: '/blog?category=lifestyle' },
]
...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-surface border-b border-outline-variant">
      <nav className="max-w-[1280px] mx-auto px-4 md:px-16 h-14 flex items-center justify-between gap-6">

        {/* Logo */}
        <Link href="/" className="font-serif text-xl font-semibold text-on-surface tracking-tight shrink-0">
          The Royal
        </Link>
